...
public class AlerteApiController {
    ...
    // On force l'association en écrivant "idDemande" dans l'annotation
    @GetMapping("/demande/{idDemande}")
    public ResponseEntity<List<String>> getAlertes(@PathVariable("idDemande") int idDemande) {
        System.out.println("                DEBUGGGG idDemande recu dans alerte controller " + idDemande);
